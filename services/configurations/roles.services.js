...
class RoleServices {
  ...
  // ================================= CRUD ================================= //
  async createRole(name, { target, isDefault, actor, t } = {}) {
    const createData = { name, target, isDefault };
  ...
  async getListRoles({ limit, page, search, ids = [], fields = [], active, target, isDefault } = {}) {
    const optionsQuery = {
      where: {},
      include: [
    ...
    if (target !== undefined) optionsQuery.where.target = target;
  ...
  async getRoleDetails({ id, search, fields = [], active, target, isDefault, includeHistory = false } = {}) {
    const optionsQuery = {
      where: {},
      include: [
        // Add your model includes here
  ...
  async updateRole(id, { name, target, isDefault, active, actor, t } = {}) {
    const updateData = { name, target, isDefault };
