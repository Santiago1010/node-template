      ...
      'application/json': {
        schema: {
          ...
          properties: {
            ...
            theme: {
              type: 'string',
              description: '**[Optional]** Preferred theme type (color scheme) of the platform for the user.',
              enum: ['ligth', 'dark'],
              example: faker.helpers.arrayElement(['ligth', 'dark']),
            },
            whatsapp: {
              type: 'integer',
              description: '**[Optional]** Indicates whether you allow receiving notifications via WhatsApp.',
              min: 0,
              max: 9,
            ...
            sms: {
              type: 'integer',
              description: '**[Optional]** Indicates whether you allow receiving SMS notifications.',
              min: 0,
              max: 9,
              example: faker.number.int({ min: 0, max: 9 }),
            },
            email: {
              type: 'integer',
              description:
                '**[Optional]** Indicates whether you allow receiving notifications and/or advertising by email.',
              min: 0,
              max: 9,
              example: faker.number.int({ min: 0, max: 9 }),
            },
