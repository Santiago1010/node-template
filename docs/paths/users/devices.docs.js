      ...
      'application/json': {
        schema: {
          ...
          properties: {
            ...
            fingerprint: {
              type: 'string',
              description: '**[Required]** Unique hash identifying the device (based on user agent, IP pattern, etc).',
              maxLength: 64,
              example: faker.string.alphanumeric(64),
            },
            name: {
              type: 'string',
              description: '**[Optional]** Friendly name for the device (e.g., "iPhone de Juan", "Chrome en Windows").',
              maxLength: 150,
              example: faker.string.alphanumeric(150),
            },
            type: {
              type: 'string',
              description: '**[Optional]** Type of device.',
              enum: ['desktop', 'mobile', 'tablet', 'other'],
              example: faker.helpers.arrayElement(['desktop', 'mobile', 'tablet', 'other']),
            },
            browser: {
              type: 'string',
              description: '**[Optional]** Browser name and version.',
              maxLength: 50,
            ...
            isTrusted: {
              type: 'boolean',
              description: '**[Optional]** Indicates whether the device is trusted.',
              enum: [true, false],
              example: faker.datatype.boolean(),
            },
            isBlocked: {
              type: 'boolean',
              description: '**[Optional]** Indicates whether the device has been blocked.',
              enum: [true, false],
              example: faker.datatype.boolean(),
            },
            lastIp: {
              type: 'string',
              description: '**[Optional]** Last IP address used by this device.',
              maxLength: 45,
              example: faker.string.alphanumeric(45),
            },
            lastUsedAt: {
              type: 'string',
              description: '**[Optional]** Last time this device was used.',
              format: 'date-time',
      ...
      'application/json': {
        schema: {
          ...
          properties: {
            ...
            fingerprint: {
              type: 'string',
              description: '**[Optional]** Unique hash identifying the device (based on user agent, IP pattern, etc).',
              maxLength: 64,
              example: faker.string.alphanumeric(64),
            },
            name: {
